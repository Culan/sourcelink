...
{
    public class BitBucketEnterpriseGitTests : DotNetSdkTestBase
    {
        public BitBucketEnterpriseGitTests()
            : base("Microsoft.SourceLink.BitBucketEnterprise.Git")
        {
        }
...
<ItemGroup>
  <SourceLinkBitBucketEnterpriseGitHost Include='cloudbitbucket.com'/>
</ItemGroup>
",
                customTargets: "",
                targets: new[]
